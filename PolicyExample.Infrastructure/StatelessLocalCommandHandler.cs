...
namespace PolicyExample.Infrastructure
{
    public class StatelessLocalCommandHandler:ICommandExecutor
    {
        ...
        public StatelessLocalCommandHandler(IAggregateFactory factory, IEventStore eventStore, ISnapshotStore snapshotStore)
        {
            _factory = factory;
        ...
        private async Task<IAggregate> LoadAggregate(ICommand command)
        {
